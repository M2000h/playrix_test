...
1. Сделать аугментацию изображений 
(тем более что исходные картинки в 4К, есть куда обрезать);
2. Подтьюнить параметры обучения и инференса;
3. художника есть еще несколько коллекций изображений, их можно добавить в датасет;
4. Научить модель рисовать, имитируя рельеф холста;
