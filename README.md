...
Что ж, видимо, нейросеть не знает, как выглядит МГУ. (небольшой забавный факт — левое двух башенное здание на фоне скорее
всего результат обучение на двух башенной конструкции, которая переодически есть в артах художника)
...
Конечно, можно еще чуть-чуть подшаманить с промптом, но главное, что стало понятно, — нейросеть не знает, как выглядит
...
Но перед этим снова обучим модель с 0 на стиль художника, но уже **в разрешении 1024 вместо 768 так же на 1000 итераций
**,
чтобы улучшить мелкие детали, а также посмотрим:
