...
чтобы не растягивать и так большое описание, 
...
Видимо, слишком простой промпт. Пробуем снова `Moscow Red Square, in sksartist style`:

<img src="/images/kremlin2.png" width="700px" />

Можно еще чуть-чуть подшаманить с промптом, но главное, что понятно, — нейросеть не знает, как выглядит
...
Теперь обучаем локациям. Запускаем кремль (20 фотографий) с параметрами:
