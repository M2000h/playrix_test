...
4. художника есть еще несколько коллекций изображений, их можно добавить в датасет;
5. Научить модель рисовать, имитируя рельеф холста;
6. Добавить оценку качества с помощью других моделей;
